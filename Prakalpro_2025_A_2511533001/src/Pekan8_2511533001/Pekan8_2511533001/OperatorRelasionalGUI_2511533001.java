...
public class OperatorRelasionalGUI_2511533001 extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    OperatorRelasionalGUI_2511533001 frame = new OperatorRelasionalGUI_2511533001();
     ...
     * Create the frame.
     */
    public OperatorRelasionalGUI_2511533001() {
